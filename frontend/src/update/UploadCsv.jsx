...
function UploadCsv() {
  ...
  const handleDownloadMockData = () => {
    // Create a mock CSV data matching the full schema
    const mockData =
      "rollNo,name,hostellerDayScholar,gender,yearOfStudy,branch,section,parentMobileNo,studentMobileNo,superPacc\n" +
      "21PA1A0501,John Doe,Day Scholar,Male,II,AIDS,A,9876543210,9876543211,Yes\n" +
      "21PA1A0502,Jane Smith,Hosteller,Female,II,AIDS,A,9876543212,9876543213,No\n" +
      "21PA1A0503,Bob Johnson,Day Scholar,Male,II,AIDS,A,9876543214,9876543215,Yes";
